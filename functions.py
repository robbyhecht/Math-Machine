...
def triangle():
    ...
    if calc == 'side' or calc == 's':
        ...
        if sideType == 'hypotenuse' or sideType == 'h':
            ...
            while b.isdigit() == False or int(b) == 0:
...
def circle():
    ...
    if calc == 'circumference' or calc == 'c':
        ...
        while r.isdigit() == False or int(r) == 0:
...
def sphere():
    ...
    if calc == 'surface area' or calc == 'area' or calc == 's':
        ...
        while d.isdigit() == False or int(d) == 0:
    ...
    if calc == 'diameter' or calc == 'd':
        ...
        if asset == 'volume' or asset == 'v':
            ...
            while v.isdigit() == False or int(v) == 0:
...
def box():
    ...
    if calc == 'surface area' or calc == 'area' or calc == 's':
        ...
        while h.isdigit() == False or int(h) == 0:
